...
The danceability scores are skewed to the left instead of normally distributed. Most songs are bunched up between about 0.55 and 0.85, but some songs have much lower scores, and they make a tail stretching toward 0. The mean is about 0.67, which is a little lower than the median of 0.69, and I think that's because the low scoring songs pull the average down. Overall, the mean tells me that most popular songs from 2020 were pretty danceable, and only a small number of songs weren't made for dancing.
